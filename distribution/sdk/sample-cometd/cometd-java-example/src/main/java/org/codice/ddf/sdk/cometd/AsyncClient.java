...
/**
 * This class is used to establish a session with the DDF cometd api. It provides the capability to
 * monitor notifications, activities as well as the ability to issue queries and download products.
 */
public class AsyncClient {
  ...
  /**
   * Retrieves all persisted notification. The notifications channel returns any persisted
   * notifications when it receives an empty message on the channel
   */
  ...
  /**
   * Retrieves all persisted activities. The activities channel returns any persisted activities
   * when it receives an empty message on the channel
   */
