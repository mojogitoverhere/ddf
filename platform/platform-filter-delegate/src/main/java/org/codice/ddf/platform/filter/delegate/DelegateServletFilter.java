...
/**
 * {@link DelegateServletFilter} is meant to detect any ServletFilters and call their {@link
 * FilterChain}. If none are found it becomes a pass through filter.
 */
    ...
    if (referenceCollection != null && !referenceCollection.isEmpty()) {
      ...
      while (iterator.hasNext()) {
        ...
        if (!curFilter.getClass().toString().equals(this.getClass().toString())) {
          LOGGER.debug(
              "Adding filter that has a service ranking of {}",
