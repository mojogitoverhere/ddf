...
public class ApplicationServiceImplTest {
  ...
  public void testGetApplications() throws Exception {
    Set<Repository> activeRepos =
        new HashSet<Repository>(Arrays.asList(noMainFeatureRepo1, noMainFeatureRepo2));
  ...
  public void testGetApplicationStatusCoreFeature() throws Exception {
    Set<Repository> activeRepos =
        new HashSet<Repository>(Arrays.asList(createRepo(TEST_PREREQ_MAIN_FEATURE_FILE_NAME)));
  ...
  public void testApplicationTree() throws Exception {
    Set<Repository> activeRepos =
        new HashSet<Repository>(Arrays.asList(mainFeatureRepo, mainFeatureRepo2));
    ...
    assertEquals(
        "main-feature2", mainAppNode.getChildren().iterator().next().getApplication().getName());
  ...
  public void testStartApplicationMainFeature() throws Exception {
    ...
    verify(featuresService, atLeastOnce())
        .installFeatures(featureNames, EnumSet.of(Option.NoAutoRefreshBundles));
  }
  ...
  public void testRemoveApplicationURIParam() throws Exception {
    Set<Repository> activeRepos =
        new HashSet<Repository>(Arrays.asList(mainFeatureRepo, noMainFeatureRepo2));
    FeaturesService featuresService = createMockFeaturesService(activeRepos, null, null);
    when(bundleContext.getService(mockFeatureRef)).thenReturn(featuresService);
    ApplicationService appService = createPermittedApplicationServiceImpl();
  ...
  public void testRemoveApplicationStringParam() throws Exception {
    Set<Repository> activeRepos =
        new HashSet<Repository>(Arrays.asList(mainFeatureRepo, noMainFeatureRepo1));
    FeaturesService featuresService = createMockFeaturesService(activeRepos, null, null);
    when(bundleContext.getService(mockFeatureRef)).thenReturn(featuresService);
    ApplicationService appService = createPermittedApplicationServiceImpl();
