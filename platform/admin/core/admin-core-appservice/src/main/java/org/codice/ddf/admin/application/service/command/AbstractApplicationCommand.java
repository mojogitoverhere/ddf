...
/**
 * Abstract application command. Retrieves an instance of the application service for child classes
 * to use.
 */
public abstract class AbstractApplicationCommand implements Action {

  @Reference private ApplicationService applicationService;
  ...
  /**
   * Command code that operates with an application service. All output should be sent to the
   * console and nothing should be returned.
   *
   * @param applicationService
   * @throws ApplicationServiceException On any error from the application service.
   */
  abstract void doExecute(ApplicationService applicationService) throws ApplicationServiceException;
}
