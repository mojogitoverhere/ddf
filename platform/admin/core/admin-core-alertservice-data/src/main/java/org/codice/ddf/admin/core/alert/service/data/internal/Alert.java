...
public class Alert {
   ...
   *
   * @param key non-empty key of the {@link Alert} which may be used to manage the {@link Alert} in
   *     a collection
   ...
   */
  public Alert(
      @Size(min = 1) String key, Level level, @Size(min = 1) String title, List<String> details) {
   ...
   *
   * @return the nullable key of the {@link Alert} which may be used to manage the {@link Alert} in
   *     a collection
   */
  @Nullable
