...
public interface AlertServiceBeanMBean {
  ...
  /**
   * @return a list of the current {@link
   *     org.codice.ddf.admin.core.alert.service.data.internal.Alert}s
   */
  List<Map<String, Object>> getAlerts();

  /**
   * Dismisses an alert from the current {@link
   * org.codice.ddf.admin.core.alert.service.data.internal.Alert}s by {@param key}
   *
