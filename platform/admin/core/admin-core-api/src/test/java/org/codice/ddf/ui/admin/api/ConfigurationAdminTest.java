...
public class ConfigurationAdminTest {
  ...
  public void setupMethod() {
    ...
    configurationAdminExt =
        new ConfigurationAdminExt(testConfigAdmin) {
          @Override
  ...
  /**
   * Tests the {@link ConfigurationAdmin#init()} method for the case where it has already been
   * initialized
   *
   * @throws Exception
   */
  ...
  /**
   * Tests the {@link ConfigurationAdmin#init()} method for the case where an exception is thrown by
  ...
  /**
   * Tests the {@link ConfigurationAdmin#destroy()} method for the case where an exception is thrown
  ...
  /**
   * Tests the {@link ConfigurationAdmin#setConfigurationAdminPluginList(List)} and {@link
   * ConfigurationAdmin#getConfigurationAdminPluginList()} methods
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#setModuleList(List)} and {@link
   * ConfigurationAdmin#getModuleList()} methods
   *
   * @throws Exception
   */
  @Test
  ...
  public void testListModules() throws Exception {
    ...
    assertThat(
        "Should return the provided modules.",
  ...
  /**
   * Tests the {@link ConfigurationAdmin#createFactoryConfiguration(String)} and {@link
   * ConfigurationAdmin#createFactoryConfigurationForLocation(String, String)} methods
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#createFactoryConfiguration(String)} and {@link
   * ConfigurationAdmin#createFactoryConfigurationForLocation(String, String)} methods for the case
  ...
  /**
   * Tests the {@link ConfigurationAdmin#delete(String)} and {@link
   * ConfigurationAdmin#deleteForLocation(String, String)} methods
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#delete(String)} and {@link
   * ConfigurationAdmin#deleteForLocation(String, String)} methods for the case where an IOException
   * is thrown
   *
   * @throws Exception
   */
  ...
  /**
   * Tests the {@link ConfigurationAdmin#deleteConfigurations(String)} method for the case where an
  ...
  /**
   * Tests the {@link ConfigurationAdmin#deleteConfigurations(String)} method for the case where the
   * filter is invalid but not null
   *
   * @throws Exception
   */
  @Test(expected = IOException.class)
  ...
  /**
   * Tests the {@link ConfigurationAdmin#getBundleLocation(String)} method for the case where the
  ...
  /**
   * Tests the {@link ConfigurationAdmin#getBundleLocation(String)} method for the case where an
   * IOException is thrown
   *
   * @throws Exception
   */
  ...
  public void testGetConfigurations() throws Exception {
    ...
    ConfigurationAdminExt configAdminExt =
        new ConfigurationAdminExt(testConfigAdmin) {
          @Override
          public boolean isPermittedToViewService(String servicePid) {
            return true;
  ...
  /**
   * Tests the {@link ConfigurationAdmin#getConfigurations(String)} method for the case where the
   * argument is null
   *
   * @throws Exception
   */
  ...
  /**
   * Tests the {@link ConfigurationAdmin#getFactoryPid(String)} and {@link
   * ConfigurationAdmin#getFactoryPidForLocation(String, String)} methods
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#getFactoryPid(String)} and {@link
   * ConfigurationAdmin#getFactoryPidForLocation(String, String)} methods for the case where the
  ...
  /**
   * Tests the {@link ConfigurationAdmin#getProperties(String)} and {@link
   * ConfigurationAdmin#getPropertiesForLocation(String, String)} methods
   *
   * @throws Exception
   */
  @Test
  public void testGetProperties() throws Exception {
    ...
    assertThat(
        "Should return the given properties.", (String) result.get(TEST_KEY), is(TEST_VALUE));
  }

  /**
   * Tests the {@link ConfigurationAdmin#getPropertiesForLocation(String, String)} method for the
  ...
  /**
   * Tests the {@link ConfigurationAdmin#setBundleLocation(String, String)} for the case where the
  ...
  /**
   * Tests the {@link ConfigurationAdmin#update(String, Map)} and {@link
   * ConfigurationAdmin#updateForLocation(String, String, Map)} methods
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#update(String, Map)} and {@link
   * ConfigurationAdmin#updateForLocation(String, String, Map)} methods and verifies when updating a
   * password with a value other than "password", it will update
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#update(String, Map)} and {@link
   * ConfigurationAdmin#updateForLocation(String, String, Map)} methods and verifies when attempting
   * to update a password with "password", it will not update it.
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#update(String, Map)} and {@link
   * ConfigurationAdmin#updateForLocation(String, String, Map)} methods for the case where the pid
   * argument is null
   */
  ...
  /**
   * Tests the {@link ConfigurationAdmin#update(String, Map)} and {@link
   * ConfigurationAdmin#updateForLocation(String, String, Map)} methods for the case where the
  ...
  /**
   * Tests the {@link ConfigurationAdmin#update(String, Map)} and {@link
   * ConfigurationAdmin#updateForLocation(String, String, Map)} methods for the case where the value
   * of an item in configurationTable is null/empty
   *
   * @throws Exception
   */
  @Test
  ...
  /**
   * Tests the {@link ConfigurationAdmin#disableConfiguration(String)} method for the case where
   * configurationAdminExt.getConfiguration(servicePid) returns null
   *
   * @throws Exception
   */
  @Test(expected = IOException.class)
  ...
  /**
   * Tests the {@link ConfigurationAdmin#disableConfiguration(String)} method for the case where the
   * pid argument is null
   *
   * @throws Exception
   */
  ...
  /**
   * Tests the {@link ConfigurationAdmin#enableConfiguration(String)} method for the case where the
  ...
  /**
   * Tests the {@link ConfigurationAdmin#enableConfiguration(String)} method for the case where
   * configurationAdminExt.getConfiguration(..) can't find the configuration
   *
   * @throws Exception
   */
  @Test(expected = IOException.class)
  ...
  private ConfigurationAdmin getConfigAdmin() throws IOException, InvalidSyntaxException {
    ...
    ConfigurationAdmin configurationAdmin =
        new ConfigurationAdmin(CONFIGURATION_ADMIN, configurationAdminExt);
