...
public class ConfigurationAdminExtTest {
  ...
  public void setUpListServices() throws Exception {
    ...
    when(testBundleContext.getAllServiceReferences(
            ManagedServiceFactory.class.getName(), TEST_FILTER))
        .thenReturn(testServRefs);
  }
  ...
  /**
   * Tests the {@link ConfigurationAdminExt#listServices(String, String)} method for the case where
  ...
  public void testListServicesExistingFilter() throws Exception {
    ...
    List<Map<String, Object>> result =
        configurationAdminExt.listServices(TEST_FACT_FILTER, TEST_FILTER);
  ...
  /**
   * Tests the {@link ConfigurationAdminExt#listServices(String, String)} and connected methods for
  ...
  /**
   * Tests the {@link ConfigurationAdminExt#listServices(String, String)} method and all associated
  ...
  /**
   * Tests the {@link ConfigurationAdminExt#getConfiguration(String)} method for the case where
   * configurationAdmin.listConfigurations(..) throws an InvalidSyntaxException
   *
   * @throws Exception
   */
  ...
  /**
   * Tests the {@link ConfigurationAdminExt#getBundle(BundleContext, String)} method for the case
