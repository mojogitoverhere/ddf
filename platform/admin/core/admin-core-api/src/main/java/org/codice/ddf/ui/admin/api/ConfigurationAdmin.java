...
public class ConfigurationAdmin implements ConfigurationAdminMBean {
  ...
  public List<Map<String, Object>> listServices() {
    return configurationAdminExt.listServices(
        getDefaultFactoryLdapFilter(), getDefaultLdapFilter());
  }
      ...
      if (configs != null) {
        configs.forEach(
            config -> {
              ...
              Map<String, Object> configProps = (Map<String, Object>) config.get(PROPERTIES_KEY);
    ...
    for (Map<String, Object> service : services) {
      ...
      if (id.equals(config.getPid())
        ...
        List<Map<String, Object>> mapList =
            (List<Map<String, Object>>) service.get(ConfigurationAdminExt.MAP_ENTRY_METATYPE);
    ...
    public Object transform(Object input) {
      ...
      for (Map<String, Object> property : metatype) {
        if (attrId.equals(property.get(ConfigurationAdminExt.MAP_ENTRY_ID))) {
          cardinality =
              Integer.valueOf(
                  String.valueOf(property.get(ConfigurationAdminExt.MAP_ENTRY_CARDINALITY)));
