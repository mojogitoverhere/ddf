...
public class ConfigStatusCommandTest {
  ...
  @Mock private ConfigurationStatusService mockConfigStatusService;
  ...
  public void testDoExecuteReportFailedImports() throws Exception {
    ...
    MigrationStatusCommand migrationStatusCommand =
        new MigrationStatusCommand(mockConfigStatusService) {
          @Override
    ...
    assertThat(
        ...
        is(
            String.format(
                MigrationStatusCommand.FAILED_IMPORT_MESSAGE, FAILED_CONFIG_FILE1.toString())));
    assertThat(values.get(0), is(ERROR_RED));
    assertThat(
        values.get(3),
        is(
            String.format(
                MigrationStatusCommand.FAILED_IMPORT_MESSAGE, FAILED_CONFIG_FILE2.toString())));
  }
  ...
  public void testDoExecuteRuntimeExceptionWhileReadingFailedDirectory() throws Exception {
    ...
    assertThat(values.get(0), is(ERROR_RED));
    assertThat(
        values.get(1), containsString("An error was encountered while executing this command."));
  }
