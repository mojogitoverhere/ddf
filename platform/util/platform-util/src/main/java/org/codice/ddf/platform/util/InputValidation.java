...
public class InputValidation {
  ...
  private static final List<String> BAD_MIME_TYPES =
      Arrays.asList(System.getProperty("bad.mime.types").split(","));
  ...
  public static String sanitizeFilename(String filename) {
    ...
    filename = BAD_CHAR_PATTERN.matcher(filename).replaceAll("_");
    filename = BAD_PATH_PATTERN.matcher(filename).replaceAll("_");
