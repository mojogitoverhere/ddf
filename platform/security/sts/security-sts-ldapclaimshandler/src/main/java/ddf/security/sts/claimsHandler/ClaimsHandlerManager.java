...
public class ClaimsHandlerManager {
  ...
  public void update(Map<String, Object> props) {
    ...
    try {
      ...
      registerLdapClaimsHandler(
          connection2, propertyFileLocation, userBaseDn, userNameAttribute, userDn, password);
  ...
  protected LDAPConnectionFactory createLdapConnectionFactory(String url, Boolean startTls)
    ...
    try {
      ...
      LOGGER.error(
          "Error encountered while configuring SSL. Secure connection to LDAP will fail.", e);
    }
