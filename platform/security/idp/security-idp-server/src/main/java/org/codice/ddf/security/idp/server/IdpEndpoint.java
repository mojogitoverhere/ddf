            ...
            metadataConfigurationParser
                ...
                .map(
                    e ->
                        Maps.immutableEntry(
                            e.getKey(),
                            new EntityInformation.Builder(e.getValue(), SUPPORTED_BINDINGS)
                                .build()))
  ...
  public Response processLogin(
    ...
    try {
      ...
      String assertionConsumerServiceBinding =
          ResponseCreator.getAssertionConsumerServiceBinding(authnRequest, serviceProviders);
      ...
      SamlValidator.Builder validator =
          new SamlValidator.Builder(new SimpleSign(systemCrypto))
              .setRedirectParams(
                  ...
                  signatureAlgorithm,
                  samlString,
                  serviceProviders.get(issuer).getSigningCertificate());
  ...
  private Response continueLogout(
    ...
    try {
      ...
      EntityInformation.ServiceInfo entityServiceInfo =
          serviceProviders.get(entityId).getLogoutService(incomingBinding);
