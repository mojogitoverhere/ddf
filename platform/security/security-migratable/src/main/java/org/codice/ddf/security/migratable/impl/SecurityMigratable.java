...
public class SecurityMigratable extends DescribableBean implements ConfigurationMigratable {
  ...
  public SecurityMigratable(@NotNull DescribableBean info, @NotNull MigratableUtil migratableUtil) {
  ...
  private void exportCrlFile(
      Path propertiesPath, Path exportDirectory, Collection<MigrationWarning> migrationWarnings)
      throws MigrationException {
    LOGGER.debug(
  ...
  private void exportPdpDirectory(
