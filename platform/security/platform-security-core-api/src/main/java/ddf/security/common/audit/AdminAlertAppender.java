...
/**
 * The {@link AdminAlertAppender} is configured as a backup logger to the audit logger. The {@link
 * AdminAlertAppender} will send an {@link Alert} {@link Event} on each failed logging event that
 * will be handled by the {@link org.codice.ddf.admin.core.alert.service.internal.AlertServiceBean}.
 */
public final class AdminAlertAppender implements PaxAppender {
  ...
  public void doAppend(PaxLoggingEvent event) {
    ...
    properties.put(
        Alert.ALERT_EVENT_ALERT_PROPERTY,
        new Alert(
