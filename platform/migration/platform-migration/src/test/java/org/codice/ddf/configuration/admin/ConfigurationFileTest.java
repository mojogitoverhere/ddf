...
public class ConfigurationFileTest {
  ...
  public void constructor() {
    ConfigurationFileUnderTest configurationFile =
        new ConfigurationFileUnderTest(path, properties, configAdmin, persistenceStrategy);
  ...
  public void testExportConfig() throws IOException {
    ...
    verify(persistenceStrategy, atLeastOnce()).write(any(FileOutputStream.class), same(properties));
  }
