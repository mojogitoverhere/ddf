...
public class ConfigurationFileFactoryTest {
  ...
  private class ConfigurationFileFactoryUnderTest extends ConfigurationFileFactory {
    ...
    public ConfigurationFileFactoryUnderTest(
  ...
  public void testCreateConfigurationFileForManagedService() throws Exception {
    ...
    PersistenceStrategy mockPersistenceStrategy =
        getMockPersistenceStrategy(mockInputStream, properties);
    ConfigurationFileFactory factory =
        new ConfigurationFileFactoryUnderTest(mockPersistenceStrategy, configAdmin);
  ...
  public void testCreateConfigurationFileWhenConfigFileReadThrowsConfigurationFileException()
    ...
    // Setup
    PersistenceStrategy mockPersistenceStrategy = mock(PersistenceStrategy.class);
    when(mockPersistenceStrategy.read(mockInputStream))
  ...
  public void testCreateConfigurationFileFileNotFoundExceptionOnGetInputStream() throws Exception {
    ...
    PersistenceStrategy mockPersistenceStrategy =
        getMockPersistenceStrategy(mockInputStream, properties);
    ConfigurationFileFactory factory =
        new ConfigurationFileFactory(mockPersistenceStrategy, configAdmin) {
          @Override
          InputStream getInputStream(Path path) throws FileNotFoundException {
  ...
  private PersistenceStrategy getMockPersistenceStrategy(
      InputStream mockInputStream, Dictionary<String, Object> properties) throws Exception {
    PersistenceStrategy mockPersistenceStrategy = mock(PersistenceStrategy.class);
