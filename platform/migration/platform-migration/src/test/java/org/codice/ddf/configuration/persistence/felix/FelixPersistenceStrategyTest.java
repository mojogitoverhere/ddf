...
public class FelixPersistenceStrategyTest {
  ...
  public void testReadMultiLineFile() throws Exception {
    ...
    FelixPersistenceStrategy felixPersistenceStrategy =
        new FelixPersistenceStrategyUnderTest(fileContent);
  ...
  /**
   * Note that Felix' {@link org.apache.felix.cm.file.ConfigurationHandler#read(InputStream)} does
   * not fail when a boolean's value is wrong, it just sets it to {@code false}.
   */
  @Test
