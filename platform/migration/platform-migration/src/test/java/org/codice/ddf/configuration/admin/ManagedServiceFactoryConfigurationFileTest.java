...
public class ManagedServiceFactoryConfigurationFileTest {
  ...
  @Mock private PersistenceStrategy mockPersistenceStrategy;
  ...
  public void testCreateConfig() throws Exception {
    ...
    ConfigurationFile configFile =
        new ManagedServiceFactoryConfigurationFile(
            mockPath, properties, mockConfigAdmin, mockPersistenceStrategy);
