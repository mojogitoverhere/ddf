...
/**
 * The {@link ConfigurationStatusService} interface provides a method that returns a {@link
 * Collection} of {@link MigrationWarning} objects.
 *
 * <p>Implementers of this interface provide status information about configuration files that
 * failed to import (i.e. configuration files that were move to the failed directory).
 */
