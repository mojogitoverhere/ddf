...
/**
 * Class that encapsulates a Managed Service Factory configuration file. Created by the {@link
 * ConfigurationFileFactory} class.
 */
public class ManagedServiceFactoryConfigurationFile extends ConfigurationFile {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(ManagedServiceFactoryConfigurationFile.class);

  ManagedServiceFactoryConfigurationFile(
      Path configFilePath,
  ...
  public void createConfig() throws ConfigurationFileException {
    ...
    try {
      ...
      String message =
          String.format("Unable to get or update Configuration for factory pid [%s].", factoryPid);
  ...
  public static class ManagedServiceFactoryConfigurationFileBuilder
    ...
    public ManagedServiceFactoryConfigurationFileBuilder(
    ...
    public ConfigurationFile build() {
      return new ManagedServiceFactoryConfigurationFile(
          configFilePath, properties, configAdmin, persistenceStrategy);
    }
  }
}
