...
/**
 * Class that encapsulates a Managed Service configuration file. Created by the {@link
...
public class ManagedServiceConfigurationFile extends ConfigurationFile {
  ...
  ManagedServiceConfigurationFile(
      Path configFilePath,
  ...
  public void createConfig() throws ConfigurationFileException {
    ...
    try {
      ...
      String message =
          String.format("Unable to get or update Configuration for pid [%s].", servicePid);
  ...
  public static class ManagedServiceConfigurationFileBuilder extends ConfigurationFileBuilder {
    ...
    public ManagedServiceConfigurationFileBuilder(
    ...
    public ConfigurationFile build() {
      return new ManagedServiceConfigurationFile(
