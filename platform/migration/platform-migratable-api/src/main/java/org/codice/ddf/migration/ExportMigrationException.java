...
public class ExportMigrationException extends MigrationException {
  ...
  /**
   * Constructs a new exception with a detail message that contains a common export configuration
   * error and the detail message associated with the {@code cause}.
   *
