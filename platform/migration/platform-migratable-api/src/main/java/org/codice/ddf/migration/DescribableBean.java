...
/**
 * This class may serve as a base for any service that provides the {@link Describable} methods from
 * injectable data. It is not abstract; otherwise it could not neatly be created in the blueprint
 * files or reduce the count of constructor args on its children.
 *
 * <p>The class is referred to as a 'Bean' since it only wraps data and provides no significant
 * business logic.
 *
 * <p>{@inheritDoc}
 */
public class DescribableBean implements Describable {
   ...
   *
   * @param describableInfo object containing required info to be copied into this describable.
   */
