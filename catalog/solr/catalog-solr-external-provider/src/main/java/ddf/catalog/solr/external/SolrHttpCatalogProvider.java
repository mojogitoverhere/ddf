...
public class SolrHttpCatalogProvider extends RemoteSolrCatalogProvider {
  ...
  public SolrHttpCatalogProvider(
  ...
  protected Future<SolrClient> createClient() {
    return HttpSolrClientFactory.getHttpSolrClient(
        Optional.ofNullable(getUrl()).orElse(HttpSolrClientFactory.getDefaultHttpsAddress()),
