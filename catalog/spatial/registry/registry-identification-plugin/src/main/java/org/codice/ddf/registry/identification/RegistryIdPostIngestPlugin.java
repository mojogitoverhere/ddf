...
public class RegistryIdPostIngestPlugin implements PostIngestPlugin {
  ...
  public CreateResponse process(CreateResponse input) throws PluginExecutionException {
    if (input != null
        && input.getCreatedMetacards() != null
  ...
  public DeleteResponse process(DeleteResponse input) throws PluginExecutionException {
    if (input != null
        && input.getDeletedMetacards() != null
        && Requests.isLocal(input.getRequest())) {
  ...
  /**
   * Init method initializes the id sets from the catalog. If the catalog is not available it will
   * retry later.
   */
  public void init() {
    try {
