...
public class RegistryPackageWebConverterTest {
  ...
  private ExtrinsicObjectType getFirstExtrinsicObject() {
    ...
    SlotType1 boundsSlot =
        stHelper.create("bounds", (String) null, "urn:ogc:def:dataType:ISO-19107:2003:GM_Envelope");
  ...
  private PostalAddressType getAddress(
      String city, String country, String zip, String state, String street, String streetNumber) {
  ...
  private TelephoneNumberType getPhoneNumber(
      String areaCode, String countryCode, String extension, String number, String type) {
