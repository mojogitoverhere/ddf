...
public class CswQueryFactoryTest {
    ...
    public void testPostGetRecordsValidSort()
        ...
        SortBy resultSort = queryRequest.getQuery()
                .getSortBy();
    ...
    public void testQueryTags() throws Exception {
        queryFactory.setSchemaToTagsMapping(new String[] {
                CswConstants.CSW_OUTPUT_SCHEMA + "=myTag"});
        ...
        assertThat(adapter.adapt(queryFactory.updateQueryRequestTags(queryFactory.getQueryById(ids),
