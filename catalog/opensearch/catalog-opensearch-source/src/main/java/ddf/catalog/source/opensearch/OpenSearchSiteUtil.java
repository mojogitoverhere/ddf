...
public final class OpenSearchSiteUtil {
  ...
  public static void populateSearchOptions(
      WebClient client, Query query, Subject subject, List<String> parameters) {
  ...
  public static void populateContextual(
      WebClient client, final String searchPhrase, List<String> parameters) {
  ...
  public static void populateTemporal(
      WebClient client, TemporalFilter temporal, List<String> parameters) {
   ...
   */
  public static void populateGeospatial(
      WebClient client,
