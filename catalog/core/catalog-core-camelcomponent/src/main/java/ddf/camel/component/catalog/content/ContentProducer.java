...
public class ContentProducer extends DefaultProducer {
  ...
  /**
   * Constructs the {@link org.apache.camel.Producer} for the custom Camel ContentComponent. This
   * producer would map to a Camel <code>&lt;to&gt;</code> route node with a URI like <code>
   * content:framework</code>
   *
