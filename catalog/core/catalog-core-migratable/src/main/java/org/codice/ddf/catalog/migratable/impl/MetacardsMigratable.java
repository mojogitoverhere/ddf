...
public class MetacardsMigratable extends DescribableBean implements DataMigratable {
   ...
   */
  public MetacardsMigratable(
      @NotNull DescribableBean info,
      @NotNull CatalogFramework framework,
      @NotNull FilterBuilder filterBuilder,
      @NotNull MigrationFileWriter fileWriter,
  ...
  public MetacardsMigratable(
      ...
      @NotNull MigrationFileWriter fileWriter,
      @NotNull CatalogMigratableConfig config,
      @NotNull MigrationTaskManager taskManager) {
  ...
  private void executeQueryLoop(QueryImpl exportQuery, QueryRequest exportQueryRequest)
    ...
    do {
      ...
      if (!results.isEmpty()) {
        ...
        exportQuery.setStartIndex(exportQuery.getStartIndex() + config.getExportQueryPageSize());
        exportGroupCount++;
      }
