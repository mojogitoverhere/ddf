...
@Command(
  ...
  name = "backup",
  description = "Makes a backup of the selected Solr core."
)
public class BackupCommand extends SolrCommands {
  ...
  @Option(
    ...
    required = false,
    description =
        "Full path to location where backups will be written. If none specified, "
  ...
  @Option(
    ...
    required = false,
    description =
        "Name of the Solr core to be backed up.  If not specified, the 'catalog' core will be backed up."
  )
