...
public abstract class FilterDelegate<T> {
  ...
  /**
   * Determines if the property contains search terms that are within a certain distance of each
   * other.
   *
   * @param propertyName name of property to compare
  ...
  /**
   * Determines if the property contains search terms that are not within a certain distance of each
   * other.
   *
   * @param propertyName name of property to compare
   * @param distance distance (in words) between search terms
