...
public class MetacardIdEqualityFilterDelegate extends SimpleFilterDelegate<Set<String>> {
  ...
  @Override
  public <S> Set<String> defaultOperation(
      Object property, S literal, Class<S> literalClass, Enum operation) {
    return Collections.emptySet();
  }

  @Override
  public <S> Set<String> propertyIsEqualTo(
      String propertyName,
      S literal,
  ...
  @Override
  public <S> Set<String> propertyIsNotEqualTo(
      String propertyName,
      S literal,
      Class<S> literalClass,
      ComparisonPropertyOperation operation) {
  ...
  @Override
  public Set<String> propertyIsInProximityTo(
      String propertyName, Integer distance, String searchTerm) {
    return Collections.emptySet();
  }

  @Override
  public Set<String> propertyIsNotInProximityTo(
      String propertyName, Integer distance, String searchTerm) {
    return Collections.emptySet();
  }
}
