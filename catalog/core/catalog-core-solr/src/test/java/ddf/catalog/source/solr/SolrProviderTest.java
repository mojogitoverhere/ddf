...
public class SolrProviderTest extends SolrProviderTestCase {
  ...
  protected static final String TAMPA_AIRPORT_POINT_WKT =
  ...
  protected static final String GULF_OF_GUINEA_MULTIPOLYGON_WKT =
  ...
  protected static final String GULF_OF_GUINEA_MULTILINESTRING_WKT =
  ...
  protected static final String ACROSS_INTERNATIONAL_DATELINE_LARGE_CCW_WKT =
      "POLYGON ((175 30, 175 25, -175 25, -175 30, 175 30))";

  protected static final String ACROSS_INTERNATIONAL_DATELINE_LARGE_CW_WKT =
      "POLYGON ((175 30, -175 30, -175 25, 175 25, 175 30))";

  protected static final String ACROSS_INTERNATIONAL_DATELINE_SMALL_WKT =
  ...
  protected static final String COUNTERCLOCKWISE_ARIZONA_RECTANGLE_WKT =
  ...
  protected static final String CLOCKWISE_ARIZONA_RECTANGLE_WKT =
  ...
  protected static final String ARIZONA_INTERSECTING_LINESTING_WKT =
      "LINESTRING (-115.33642578125 33.28662109375,-108.17333984375 35.83544921875)";

  protected static final String ARIZONA_INTERSECTING_MULTILINESTING_WKT =
  ...
  protected static final String FLAGSTAFF_AIRPORT_POINT_WKT =
      "POINT (-111.67121887207031 35.138454437255859)";

  protected static final String PHOENIX_AND_LAS_VEGAS_MULTIPOINT_WKT =
      "MULTIPOINT ((-112.066667 33.45), (-115.136389 36.175))";

  protected static final String ARIZONA_INTERSECTING_POLYGON_WKT =
  ...
  protected static final String ARIZONA_INTERSECTING_MULTIPOLYGON_WKT =
  ...
  protected static final String ARIZONA_POLYGON_WKT =
  ...
  protected static final String WEST_USA_CONTAINING_POLYGON_WKT =
        ...
        provider.update(
            new UpdateRequest() {
              ...
              public List<Entry<Serializable, Metacard>> getUpdates() {
                ...
                updateList.add(
                    new SimpleEntry<Serializable, Metacard>(
                        MockMetacard.DEFAULT_TITLE, newMetacard));
    ...
    provider.update(
        new UpdateRequest() {
          ...
          public List<Entry<Serializable, Metacard>> getUpdates() {
            ...
            updateList.add(
                new SimpleEntry<Serializable, Metacard>(MockMetacard.DEFAULT_TITLE, newMetacard));
        ...
        new UpdateRequest() {
          ...
          public List<Entry<Serializable, Metacard>> getUpdates() {
            ...
            updateList.add(
                new SimpleEntry<Serializable, Metacard>(MockMetacard.DEFAULT_TITLE, newMetacard));
            updateList.add(
                new SimpleEntry<Serializable, Metacard>(TAMPA_QUERY_PHRASE, newMetacard));
  ...
  public void testDeleteNoList() throws IngestException, UnsupportedQueryException {
    ...
    DeleteRequestImpl emptyDeleteRequest =
        new DeleteRequestImpl(new ArrayList<Serializable>(), DeleteRequest.DELETE_BY_ID, null);
  ...
  private void verifyContentTypeUpdate(
      UpdateResponse response, String oldContentType, String newContentType) throws Exception {
    Update update = response.getUpdatedMetacards().get(0);
  ...
  public void testExtensibleMetacards() throws IngestException, UnsupportedQueryException {
    ...
    descriptors.add(
        new AttributeDescriptorImpl(
            brandNewField1, true, true, true, false, BasicTypes.STRING_TYPE));
    ...
    // search title - exact
    query =
        new QueryImpl(filterBuilder.attribute(brandNewField1).equalTo().text(brandNewFieldValue1));
    ...
    // search xml
    query =
        new QueryImpl(filterBuilder.attribute(brandNewXmlField1).like().caseSensitiveText("doe"));
    ...
    assertEquals(
        "34ga$^TGHfg:/", response.getResults().get(0).getMetacard().getMetacardType().getName());
    ...
    assertThat(
        (Double) (resultMetacard.getAttribute(doubleField).getValue()), equalTo(doubleFieldValue));
    assertThat(
        (Integer) (resultMetacard.getAttribute(intField).getValue()), equalTo(intFieldValue));
    assertThat(
        (Float) (resultMetacard.getAttribute(floatField).getValue()), equalTo(floatFieldValue));
    assertThat((Long) (resultMetacard.getAttribute(longField).getValue()), equalTo(longFieldValue));
    assertThat(
        (byte[]) (resultMetacard.getAttribute(byteField).getValue()), equalTo(byteFieldValue));
    assertThat(
        (Boolean) (resultMetacard.getAttribute(booleanField).getValue()),
    ...
    assertThat(
        (Short) (resultMetacard.getAttribute(shortField).getValue()), equalTo(shortFieldValue));
    assertThat(
        (BevelBorder) (resultMetacard.getAttribute(objectField).getValue()),
  ...
  public void testQueryHasLuceneSpecialCharacters() throws Exception {
    ...
    // required
    Filter txtFilter =
        filterBuilder.attribute(Metacard.ANY_TEXT).like().text("+Flag?taff +" + TAMPA_QUERY_PHRASE);
  ...
  public void testQueryMissingSortField() throws IngestException, UnsupportedQueryException {
    ...
    List<Metacard> list =
        Arrays.asList((Metacard) m, new MockMetacard(Library.getFlagstaffRecord()));
  ...
  public void testContextualSimpleWithLogicOperators() throws Exception {
    ...
    List<Metacard> list =
        Arrays.asList((Metacard) new MockMetacard(Library.getFlagstaffRecord()), m);
  ...
  public void testContextualCaseSensitiveWildcardWithPunctuation() throws Exception {
    ...
    query =
        queryBuilder.like(
            Metacard.ANY_TEXT,
            "http://www.flagstaffchamber.com/arizona-cardinals*",
            isCaseSensitive,
            isFuzzy);
    sourceResponse = provider.query(new QueryRequestImpl(query));
    assertEquals(1, sourceResponse.getResults().size());
  ...
  public void testContextualFuzzy() throws Exception {
    ...
    Filter filter =
        filterBuilder.attribute(Metacard.METADATA).like().fuzzyText(FLAGSTAFF_QUERY_PHRASE);
    SourceResponse sourceResponse = provider.query(new QueryRequestImpl(new QueryImpl(filter)));
    assertEquals(
  ...
  public void testTemporalDuring() throws Exception {
    ...
    for (Result content : sourceResponse.getResults()) {
      ...
      assertTrue(
          "Testing if contents has term [" + term + "]", ALL_RESULTS != metadata.indexOf(term));
    }
  ...
  public void testXpathQuery() throws Exception {
    ...
    queryXpathPositiveWithSearchPhrase(
        "//shipTo/@country", "us", PURCHASE_ORDER_QUERY_PHRASE, false);
    queryXpathPositiveWithSearchPhrase(
        "/purchaseOrder/comment", "Hurry, my lawn is going wild!", PURCHASE_ORDER_QUERY_PHRASE);
    queryXpathPositiveWithSearchPhrase(
        "/purchaseOrder/items//comment", "Confirm this is electric", "Lawnmower");
    queryXpathPositiveWithSearchPhrase(
        "//comment", "Hurry, my lawn is going wild!", PURCHASE_ORDER_QUERY_PHRASE);
    queryXpathPositiveWithSearchPhrase(
        "//comment", "Confirm this is electric", PURCHASE_ORDER_QUERY_PHRASE);
    queryXpathPositiveWithSearchPhrase(
        "//items//comment", "Confirm this is electric", PURCHASE_ORDER_QUERY_PHRASE);
    queryXpathPositiveWithSearchPhrase(
        "/purchaseOrder//item/USPrice", "148.95", PURCHASE_ORDER_QUERY_PHRASE);
    queryXpathPositiveWithSearchPhrase(
        "/purchaseOrder//item/USPrice", "39.98", PURCHASE_ORDER_QUERY_PHRASE);
    queryXpathPositiveWithSearchPhrase(
        "/purchaseOrder//item[2]/USPrice", "39.98", PURCHASE_ORDER_QUERY_PHRASE);
  ...
  public void queryXpathPositiveWithSearchPhrase(
  ...
  private Set<AttributeDescriptor> numericalDescriptors(
  ...
  public void testNumericSort() throws Exception {
    ...
    query.setSortBy(
        new ddf.catalog.filter.impl.SortByImpl(doubleField, SortOrder.ASCENDING.name()));
    ...
    for (int i = 0; i < list.size(); i++) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          doubleFieldValue + factor * i, r.getMetacard().getAttribute(doubleField).getValue());
    }

    // Sort all double DESCENDING

    query.setSortBy(
        new ddf.catalog.filter.impl.SortByImpl(doubleField, SortOrder.DESCENDING.name()));
    ...
    for (int i = (list.size() - 1); i >= 0; i--) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          doubleFieldValue + factor * counter,
          r.getMetacard().getAttribute(doubleField).getValue());
      counter++;
    }
    ...
    for (int i = 0; i < list.size(); i++) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          floatFieldValue + factor * i, r.getMetacard().getAttribute(floatField).getValue());
    }

    // Sort all Float DESCENDING

    query.setSortBy(
        new ddf.catalog.filter.impl.SortByImpl(floatField, SortOrder.DESCENDING.name()));
    ...
    for (int i = (list.size() - 1); i >= 0; i--) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          floatFieldValue + factor * counter, r.getMetacard().getAttribute(floatField).getValue());
      counter++;
    }
    ...
    for (int i = (list.size() - 1); i >= 0; i--) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          intFieldValue + factor * counter, r.getMetacard().getAttribute(intField).getValue());
      counter++;
    }
    ...
    for (int i = (list.size() - 1); i >= 0; i--) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          longFieldValue + factor * counter, r.getMetacard().getAttribute(longField).getValue());
      counter++;
    }
    ...
    for (int i = 0; i < list.size(); i++) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          (short) (shortFieldValue + factor * i),
          r.getMetacard().getAttribute(shortField).getValue());
    }

    // Sort all short DESCENDING

    query.setSortBy(
        new ddf.catalog.filter.impl.SortByImpl(shortField, SortOrder.DESCENDING.name()));
    ...
    for (int i = (list.size() - 1); i >= 0; i--) {
      Result r = sourceResponse.getResults().get(i);
      assertEquals(
          (short) (shortFieldValue + factor * counter),
          r.getMetacard().getAttribute(shortField).getValue());
      counter++;
    }
  }
  ...
  public void testStartIndexWithSorting() throws Exception {
    ...
    SortByImpl sortBy =
        new SortByImpl(
            queryBuilder.filterFactory.property(Metacard.EFFECTIVE),
  ...
  public void testSpatialPointRadius() throws Exception {
    ...
    SortByImpl sortby =
        new SortByImpl(
            builder.filterFactory.property(Result.DISTANCE),
            org.opengis.filter.sort.SortOrder.ASCENDING);
    query.setSortBy(sortby);
    query.setPageSize(3);
    sourceResponse = provider.query(new QueryRequestImpl(query));
  ...
  public void testSortedPointRadiusWithComplexQuery() throws Exception {
    ...
    Filter spatialFilter =
        filterBuilder.attribute(Metacard.GEOGRAPHY).intersecting().wkt(FLAGSTAFF_AIRPORT_POINT_WKT);
  ...
  public void testSpatialNearestNeighbor() throws Exception {
    ...
    Filter positiveFilter =
        filterBuilder.attribute(Metacard.GEOGRAPHY).beyond().wkt(PHOENIX_POINT_WKT, 0);
    ...
    // Using WKT polygon
    positiveFilter =
        filterBuilder.attribute(Metacard.GEOGRAPHY).beyond().wkt(ARIZONA_POLYGON_WKT, 0);
  ...
  private void spatialDistanceCalculationBetweenTwoPoints(String attribute, String sortBy)
    ...
    double radiusInMeters = radiusInKilometers * METERS_PER_KM;
    Filter positiveFilter =
        filterBuilder.attribute(attribute).withinBuffer().wkt(PHOENIX_POINT_WKT, radiusInMeters);
  ...
  public void testSpatialWithin() throws Exception {
    Filter positiveFilter =
        filterBuilder.attribute(Metacard.GEOGRAPHY).within().wkt(ARIZONA_POLYGON_WKT);
    Filter negativeFilter =
        filterBuilder.attribute(Metacard.GEOGRAPHY).within().wkt(GULF_OF_GUINEA_POLYGON_WKT);
  ...
  public void testSpatialPointIntersectsPoint() throws Exception {
    testSpatialIntersectsWithWkt(
        FLAGSTAFF_AIRPORT_POINT_WKT, FLAGSTAFF_AIRPORT_POINT_WKT, GULF_OF_GUINEA_POINT_WKT);
  }

  @Test
  public void testSpatialMultiPointIntersectsPoint() throws Exception {
    testSpatialIntersectsWithWkt(
        GULF_OF_GUINEA_POINT_WKT, GULF_OF_GUINEA_MULTIPOINT_WKT, FLAGSTAFF_AIRPORT_POINT_WKT);
  }
  ...
  public void testSpatialPolygonIntersectsPoint() throws Exception {
    testSpatialIntersectsWithWkt(
        ARIZONA_POLYGON_WKT, FLAGSTAFF_AIRPORT_POINT_WKT, GULF_OF_GUINEA_POINT_WKT);
  }

  @Test
  public void testSpatialPolygonIntersectsLineString() throws Exception {
    testSpatialIntersectsWithWkt(
        ARIZONA_POLYGON_WKT, ARIZONA_INTERSECTING_LINESTING_WKT, GULF_OF_GUINEA_LINESTRING_WKT);
  }

  @Test
  public void testSpatialPolygonIntersectsPolygon() throws Exception {
    testSpatialIntersectsWithWkt(
        ARIZONA_POLYGON_WKT, ARIZONA_INTERSECTING_POLYGON_WKT, GULF_OF_GUINEA_POLYGON_WKT);
  }

  @Test
  public void testSpatialPolygonIntersectsMultiPoint() throws Exception {
    testSpatialIntersectsWithWkt(
        ARIZONA_POLYGON_WKT, PHOENIX_AND_LAS_VEGAS_MULTIPOINT_WKT, GULF_OF_GUINEA_MULTIPOINT_WKT);
  }
  ...
  public void testSpatialGeometryCollectionIntersectsPoint() throws Exception {
    testSpatialIntersectsWithWkt(
        ARABIAN_SEA_OVERLAPPING_GEOMETRYCOLLECTION_WKT,
  ...
  public void testSpatialPointWithinPolygon() throws Exception {
    testSpatialWithinWithWkt(
        FLAGSTAFF_AIRPORT_POINT_WKT, WEST_USA_CONTAINING_POLYGON_WKT, GULF_OF_GUINEA_POLYGON_WKT);
  }
  ...
  public void testSpatialPolygonWithinPolygon() throws Exception {
    testSpatialWithinWithWkt(
        ARIZONA_INTERSECTING_POLYGON_WKT,
        WEST_USA_CONTAINING_POLYGON_WKT,
        GULF_OF_GUINEA_POLYGON_WKT);
  }
  ...
  public void testSpatialMultiPointWithinPolygon() throws Exception {
    testSpatialWithinWithWkt(
        PHOENIX_AND_LAS_VEGAS_MULTIPOINT_WKT,
        WEST_USA_CONTAINING_POLYGON_WKT,
        GULF_OF_GUINEA_POLYGON_WKT);
  }
  ...
  public void testSpatialPolygonContainsPoint() throws Exception {
    Filter positiveFilter =
        filterBuilder.attribute(Metacard.GEOGRAPHY).containing().wkt(FLAGSTAFF_AIRPORT_POINT_WKT);
    Filter negativeFilter =
        filterBuilder.attribute(Metacard.GEOGRAPHY).containing().wkt(GULF_OF_GUINEA_POINT_WKT);
  ...
  public void testSpatialAnyGeo() throws Exception {
    Filter positiveFilter =
        filterBuilder.attribute(Metacard.ANY_GEO).within().wkt(ARIZONA_POLYGON_WKT);
    Filter negativeFilter =
        filterBuilder.attribute(Metacard.ANY_GEO).within().wkt(GULF_OF_GUINEA_POLYGON_WKT);
    testSpatialWithWkt(FLAGSTAFF_AIRPORT_POINT_WKT, positiveFilter, negativeFilter);
  }
