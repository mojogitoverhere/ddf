...
public class WorkspacePolicyExtensionTest {
  ...
  private static final Permission ADMIN_EMAIL =
      makePermission(Constants.EMAIL_ADDRESS_CLAIM_URI, ImmutableSet.of("admin@localhost"));

  private static final Permission SYSTEM_ROLE =
      makePermission(Constants.ROLES_CLAIM_URI, ImmutableSet.of("system"));
