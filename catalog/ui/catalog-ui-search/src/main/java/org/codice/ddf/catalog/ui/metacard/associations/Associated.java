...
public class Associated {
  ...
  private static final Set<String> ASSOCIATION_TYPES =
      ImmutableSet.of(AssociationsAttributes.DERIVED, AssociationsAttributes.RELATED);
  ...
  public Collection<Edge> getAssociations(List<String> writableSourceIds, String metacardId)
    ...
    Map<String, Metacard> metacardMap =
        query(writableSourceIds, withNonrestrictedTags(forRootAndParents(metacardId)));
    ...
    Map<String, Metacard> childMetacardMap =
        query(writableSourceIds, withNonrestrictedTags(forChildAssociations(root)));
  ...
  public void putAssociations(List<String> writableSourceIds, String id, Collection<Edge> edges)
    ...
    Map<String, Metacard> metacards =
        util.getMetacards(writableSourceIds, ids, getNonrestrictedTagsFilter())
            .entrySet()
            .stream()
